...
class TermOfUse extends Component {
    componentDidMount() {
        document.title = `Term of Use' | ${process.env.REACT_APP_DOC_TITLE}`;
    }
    render() {
        return (
            <Container>
                <div className='p-3'>
                    ...
                    <p>Last updated: January 17, 2020</p>
                    ...
                    <ul>
                        ...
                        <li>
                            ...
                            and Conditions agreement as been created with the
                            help of{' '}
                        ...
                        <li>
                            <strong>Website</strong> refers to CodeWithSia,
                            accessible from codewithsia.com
                        </li>{' '}
                        <li>
                    ...
                    <ul>
                        <li>By email: sia.qnbr@gmail.com</li>
                        <li>
