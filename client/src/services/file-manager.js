...
const API_FETCH_ALL_ITEMS = `${process.env.REACT_APP_API_ENDPOINT}/file-manager/`;
const API_CREATE_DIRECTORY = `${process.env.REACT_APP_API_ENDPOINT}/file-manager/create-dir`;
